...
const languages = [
  ...
  { code: 'de', name: 'German' },
    ...
    { code: 'zh-CH', name: 'Simplified Chinese' },
...
playButton.addEventListener('click', async () => {
    ...
    try {
      ...
      playText(text, selectedVoiceIndex);
  
      // Wait for the first text-to-speech to finish before translating
      const checkSpeaking = setInterval(() => {
        if (!speechSynthesis.speaking) {
          clearInterval(checkSpeaking);
  
          // Translate and play the translated text after the original
